...
model = joblib.load('classificacao_modelo_metricas.pkl')

# Rota para inicial
@app.route('/', methods=['GET'])
def home():
    return 'Modelo de classificacao para análise de propensão à inadimplencia.'
...
def predict():
    ...
    predictions = model["classificacao"].predict(df)
